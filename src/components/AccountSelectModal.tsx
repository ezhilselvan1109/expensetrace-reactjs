          ...
          <div className="space-y-1.5 sm:space-y-2">
            {filteredAccounts.map((account) => (
              ...
              >
                ...
                <div className="flex-1 text-left">
                  <p className="text-sm sm:text-base font-medium text-gray-900 truncate">{account.name}</p>
                  <div className="flex items-center space-x-2">
                    <p className="text-xs sm:text-sm text-gray-500 capitalize">{account.type}</p>
